...
import { getRemitterProfile } from "../api/remitter-user";
import { login as authenticate, logout } from "../api/authentication";
...
export const AuthContextProvider = ({
  ...
  const getRemitterUser: any = async () => {
    try {
      return await getRemitterProfile();
    } catch (err) {
  ...
  const login = async (data: LoginData) => {
    ...
    const remitterUser = await getRemitterUser();
